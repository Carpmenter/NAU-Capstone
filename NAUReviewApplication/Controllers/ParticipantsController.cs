...
namespace NAUReviewApplication.Controllers
{
    public class ParticipantsController : Controller
    {
        ...
        {
            var nAUcountryContext = _context.Participant.Include(p => p.Group);
            return View(await nAUcountryContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ParticipantId,GroupId,Username")] Participant participant)
        {
